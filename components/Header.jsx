    ...
    return(
        <div className="flex justify-center items-center gap-56 w-screen h-16 bg-light-300 dark:bg-dark-500">
            <nav className="flex items-center">
                <a href="/" className="text-xl font-bold hover:text-dark-300 dark:hover:text-textLight-300 transition-colors mr-9">
                    Guilherme Ferreira
                </a>
                {[
                    ['Projetos', '/projects', '1'],
                    ...
                    <div className="group relative w-fit mx-4 flex" key={id}>
                        ...
                        <a href={url} className="font-normal text-base duration-300 hover:text-dark-300 dark:hover:text-textLight-300">
                            {title}
                        </a>
