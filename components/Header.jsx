  ...
  return (
    <header
      className="fixed top-0 z-20 flex h-16 w-screen items-center 
        justify-center gap-56 bg-light-300/90 px-10 backdrop-blur-md dark:bg-dark-500/90 max-md:justify-between max-md:gap-0"
    >
      ...
      <ThemeChanger />
      <div className='hidden w-[150px] max-md:flex justify-center'>
